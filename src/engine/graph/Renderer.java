...
public class Renderer {
    ...
    private void setupParticlesShader() throws Exception {
        ...
        particlesShaderProgram.createVertexShader(Utils.loadResource("/resources/shaders/particles_vertex.vs"));
        particlesShaderProgram.createFragmentShader(Utils.loadResource("/resources/shaders/particles_fragment.fs"));
    ...
    private void setupDepthShader() throws Exception {
        ...
        depthShaderProgram.createVertexShader(Utils.loadResource("/resources/shaders/depth_vertex.vs"));
        depthShaderProgram.createFragmentShader(Utils.loadResource("/resources/shaders/depth_fragment.fs"));
